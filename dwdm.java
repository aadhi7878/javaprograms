...
import java.util.*;
public class dwdm {
	public static void generateCombinations(List<String> elements, List<String> currentCombination, int numElements, List<List<String>> combinations) {
        if (numElements == 0) {
	    ...
	    for (int i = 0; i < elements.size(); i++) {
            ...
            generateCombinations(elements.subList(i + 1, elements.size()), currentCombination, numElements - 1, combinations);
	...
	public static HashMap<Set<String>,Integer>  Scan(List<Set<String>> transactions,HashMap<Set<String>,Integer> combinations,int min_support){
